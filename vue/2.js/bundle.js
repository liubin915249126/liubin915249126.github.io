...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_login_vue__ = __webpack_require__(267);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_11936bf0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_login_vue__ = __webpack_require__(279);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_11936bf0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_login_vue__["a" /* default */],
...
exports.default = {
    ...
    beforeCreate: function () {
        var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
            var checkloginurl, _ref2, data, userInfo;

            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            checkloginurl = '/account/IsAuthenticate';
                            _context.next = 3;
                            return _request2.default.get(checkloginurl);
                        ...
                        case 3:
                            ...
                            userInfo = (0, _utils.getCookie)("getnameJson");
    ...
    methods: {
        login: function login() {
            ...
            this.$refs.ruleForm.validate(function () {
                var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(valid) {
                    var _ref4, data;
                        ...
                        while (1) {
                            switch (_context2.prev = _context2.next) {
                                ...
                                case 4:
                                    ...
                                    console.log(data);
                                    if (data1.RememberMe) {
                                        (0, _utils.setCookie)('getnameJson', (0, _stringify2.default)({ "userName": data1.UsernameOrEmailAddress, "tenancyName": data1.TenancyName, "remberUser": data1.RememberMe }), 30);
                                        //setCookie('path','/',30)
                                    } else {
                                        (0, _utils.delCookie)('getnameJson');
                                        //delCookie('path')
                                    }
                                    if (data.success) {
                                        //后台验证成功后登陆
        ...
        logintomain: function logintomain() {
            this.$router.push({ path: '/main' });
        },
...
var update = __webpack_require__(10)("68de57e6", content, true, {});
...
// module
exports.push([module.i, ".loginwrap{width:400px;margin:0 auto;border:1px solid #eee}.loginwrap h3{text-align:center}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"loginwrap"},[(_vm.logined)?_c('div',[_c('h3',[_vm._v("欢迎回来")]),_vm._v(" "),_c('el-button',{on:{"click":_vm.switchlogin}},[_vm._v("切换账号")]),_vm._v(" "),_c('el-button',{on:{"click":_vm.logintomain}},[_vm._v("登录")])],1):_c('el-form',{ref:"ruleForm",staticClass:"demo-ruleForm",attrs:{"model":_vm.ruleForm,"rules":_vm.rules,"label-width":"100px"}},[_c('h3',[_vm._v("欢迎登录系统")]),_vm._v(" "),_c('el-form-item',{attrs:{"label":"租户名","prop":"name"}},[_c('el-input',{model:{value:(_vm.ruleForm.name),callback:function ($$v) {_vm.$set(_vm.ruleForm, "name", $$v)},expression:"ruleForm.name"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"用户名","prop":"username"}},[_c('el-input',{model:{value:(_vm.ruleForm.username),callback:function ($$v) {_vm.$set(_vm.ruleForm, "username", $$v)},expression:"ruleForm.username"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"密码","prop":"password"}},[_c('el-input',{attrs:{"type":"password"},model:{value:(_vm.ruleForm.password),callback:function ($$v) {_vm.$set(_vm.ruleForm, "password", $$v)},expression:"ruleForm.password"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"记住密码","prop":"rememberMe"}},[_c('el-checkbox',{model:{value:(_vm.ruleForm.rememberMe),callback:function ($$v) {_vm.$set(_vm.ruleForm, "rememberMe", $$v)},expression:"ruleForm.rememberMe"}})],1),_vm._v(" "),_c('el-form-item',[_c('el-button',{attrs:{"type":"primary"},on:{"click":_vm.login}},[_vm._v("登录")])],1)],1)],1)}
var staticRenderFns = []
